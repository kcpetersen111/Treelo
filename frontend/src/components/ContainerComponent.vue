<template>
  ...
  <v-card>
    ...
    <v-card-title class="text-h4 blue--text font-weight-bold text-wrap" style="word-break:break-word; -webkit-hyphens: manual; -moz-hyphens: manual; -ms-hyphens: manual; hyphens: manual;">
      {{ containerData.name }}
    </v-card-title>
    <!--
    <v-card-text>
